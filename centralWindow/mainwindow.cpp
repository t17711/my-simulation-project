...
MainWindow::MainWindow()
{
    ...
    setCentralWidget(spreadsheet); // add spreadsheet as central widget
...
{
    // same action can be triggered by menu bar and tool bar
...
{
    fileMenu = menuBar()->addMenu(tr("&File"));  // add menu to menuar
    fileMenu->addAction(newAction); // add to file menu
    ...
    editMenu = menuBar()->addMenu(tr("&Edit"));  // edint menu
    editMenu->addAction(cutAction);
    editMenu->addAction(copyAction);
    editMenu->addAction(pasteAction);
    editMenu->addAction(deleteAction);

    selectSubMenu = editMenu->addMenu(tr("&Select"));  // select on edit
    ...
    toolsMenu = menuBar()->addMenu(tr("&Tools"));  // tool menu
    toolsMenu->addAction(recalculateAction);
    toolsMenu->addAction(sortAction);

    optionsMenu = menuBar()->addMenu(tr("&Options"));  // options
